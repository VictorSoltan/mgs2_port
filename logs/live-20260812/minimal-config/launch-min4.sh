#!/bin/bash
# MGS2 Substance RG353VS -- MIN4: MIN30 minus the presentation path. the smallest stack measured at 30 fps.
...
# winewayland_stall1.so (patch 10) NOT mounted: testing whether the stock
# winewayland present path reaches the screen on this device. Untested before.
