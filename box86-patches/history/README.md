...
чистому upstream box86 0579f8b9 они дают
...
Собирать надо из `box86-patches/FINALPLAY*-box86-complete.patch` поверх
закреплённого коммита `0579f8b9`. Проверяет это `harness/verify_rebuild.sh`,
