...
D3D9=d3d9_dxvk_sarek_1.11.1_mali_pipeline_trace1.dll
...
verify_one 43c10d5a189cc72a672025d10e8e672ce28776afd26b66eb9983e17fde929b34 "$D3D9"
verify_one 83f9349c6dc26f8f769e714a5ed57c4d76f3a523161ead31f75e52ccc1da7fba "$BOX86"

export MGS2_RESEARCH_RUN=dxvk-sarek-pipeline-trace
...
export MGS2_IDENTITY_MANIFEST=FINALPLAY16_DXVK_PIPELINE_TRACE.manifest
...
echo "MGS2 DXVK: PIPELINE TIMELINE RESEARCH, state_cache=$DXVK_STATE_CACHE cache_path=$DXVK_STATE_CACHE_PATH" >&2
